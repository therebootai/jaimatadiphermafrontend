...
const FooterComponent = () => {
  ...
  return (
    <div className="xl:p-16 lg:p-8 sm:p-4 bg-[#F1F1F1]">
      <div className="flex sm:flex-col lg:flex-row sm:gap-8 lg:gap-5 xl:gap-8">
        ...
        <div className="flex flex-1 flex-col sm:gap-6 lg:gap-4 xl:gap-8">
          <div className="flex ">
          ...
          <div className="flex flex-col sm:gap-4 xl:gap-6 sm:text-base  xlg:text-lg">
